...
public class User {
    ...
    public User(int userId, String email, String password, String nickname) { //추가
        this.userId = userId;
        this.email = email;
    ...
    @Override public String toString() { //toString 오버라이딩 했다.
        return getClass().getSimpleName() + "[userId=" + userId + ", nickname=" + nickname + ", email="+ email+ ", img="+ imageUrl+"]";
    }
}
